...
install_wp() {
	...
	if [[ $WP_VERSION == 'nightly' || $WP_VERSION == 'trunk' ]]; then
		...
		tar --strip-components=1 --force-local -zxmf $TMPDIR/wordpress.tar.gz -C $WP_CORE_DIR
	fi
...
#   php wp-cli.phar theme install twentyseventeen --activate
    ...
    php wp-cli.phar plugin install http://billwerkwoodev.phhw-190202.cust.powerhosting.dk/subdomains/assets/woocommerce-subscriptions-for-phpunit-main.zip --activate --force --allow-root
